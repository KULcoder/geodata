...
class PVLib(BaseModel):
    ...
    def _estimate_dataset(self, params: xr.Dataset, **kwargs):
        pass
    ...
    def estimate(self,
        ...
        **kwargs,
        ...
        # TODO: overwrite the estimate function

        # TODO: check if pv_system never intilized, is this test valid?
        if self.pv_system is None:
            raise ValueError("pv_system is not initialized")
    ...
    def _pvlib_model(
            self,
            cutout,  # TODO: remove this cutout to the ds
            system,
            model_chain_config,
            vars = [
                'influx_diffuse', 
    ...
    def _prepare_pvlib_ds(self, cutout, *varnames):
            """
