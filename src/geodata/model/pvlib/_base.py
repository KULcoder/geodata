...
class PVLib(BaseModel):
    ...
    def _prepare_pvlib_ds(self, ds: xr.Dataset, *varnames) -> xr.Dataset:
            ...
            Requires a dataset with the following variables:

            - **influx_diffuse** (*float*) - Diffuse horizontal irradiance.  
            - **influx_direct** (*float*) - Direct normal irradiance.  
            - **d2m** (*float*) - 2m dewpoint temperature in Kelvin.  
            ...
            ----------
            ds : xarray.Dataset
                Dataset generated by `geodata` library.  Must contain following variables: influx_diffuse, influx_direct,
                d2m, temperature, wnd100m.
            varnames : string
                String values representing names of required variables to extract.
